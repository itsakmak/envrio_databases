...
class User:
    ...
    @staticmethod
    def add(user: schemas.UsersTableCreate, db: Session = SessionLocal.begin()):
...
class Stations:
    ...
    @staticmethod
    def add(station: schemas.StationsCreate, db: Session = SessionLocal.begin()):
...
class Gateways:
    ...
    @staticmethod
    def add(gateway: schemas.GatewaysCreate, db: Session = SessionLocal.begin()):
...
class RemoteTerminalUnits:
    ...
    @staticmethod
    def add(rtu: schemas.RemoteTerminalUnitsCreate, db: Session = SessionLocal.begin()):
...
class MonitoredParameters:
    ...
    @staticmethod
    def add(monitored_parameters: schemas.MonitoredParametersCreate, db: Session = SessionLocal.begin()):
...
class MeasurementsTranslations:
    ...
    @staticmethod
    def add(translation: schemas.MeasurementTranslationsCreate, db: Session = SessionLocal.begin()):
